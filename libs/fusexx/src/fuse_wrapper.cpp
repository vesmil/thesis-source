...
#if FUSE_VERSION < 30
    static int rename(const char *oldpath, const char *newpath) { return fuse().rename(oldpath, newpath, 0); }
...
int FuseWrapper::rename(const std::string &, const std::string &, unsigned int) { return -ENOSYS; }
...
int FuseWrapper::read(const std::string &, char *, size_t, off_t, struct fuse_file_info *) { return -ENOSYS; }
int FuseWrapper::write(const std::string &, const char *, size_t, off_t, struct fuse_file_info *) { return -ENOSYS; }
int FuseWrapper::statfs(const std::string &, struct statvfs *) { return 0; }
int FuseWrapper::flush(const std::string &, struct fuse_file_info *) { return -ENOSYS; }
int FuseWrapper::release(const std::string &, struct fuse_file_info *) { return 0; }
int FuseWrapper::fsync(const std::string &, int, struct fuse_file_info *) { return -ENOSYS; }
int FuseWrapper::setxattr(const std::string &, const std::string &, const std::string &, size_t, int) {
    return -ENOSYS;
}
int FuseWrapper::getxattr(const std::string &, const std::string &, char *, size_t) { return -ENOSYS; }
int FuseWrapper::listxattr(const std::string &, char *, size_t) { return -ENOSYS; }
int FuseWrapper::removexattr(const std::string &, const std::string &) { return -ENOSYS; }
...
int FuseWrapper::fsyncdir(const std::string &, int, struct fuse_file_info *) { return -ENOSYS; }
void FuseWrapper::init() {}
void FuseWrapper::destroy() {}

#if FUSE_VERSION >= 25
int FuseWrapper::access(const std::string &, int) { return -ENOSYS; }
int FuseWrapper::create(const std::string &, mode_t, struct fuse_file_info *) { return -ENOSYS; }
#endif  // FUSE_VERSION >= 25

#if FUSE_VERSION >= 26
int FuseWrapper::lock(const std::string &, struct fuse_file_info *, int, struct flock *) { return -ENOSYS; }
int FuseWrapper::utimens(const std::string &, const struct timespec[2]) { return -ENOSYS; }
...
int FuseWrapper::flock(const std::string &, struct fuse_file_info *, int) { return -ENOSYS; }
int FuseWrapper::fallocate(const std::string &, int, off_t, off_t, struct fuse_file_info *) { return -ENOSYS; }
...
int FuseWrapper::main(int argc, char *argv[]) { return fuse_main(argc, argv, &ops, this); }
